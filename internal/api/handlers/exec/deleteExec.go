...
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if err.Error() == "exec not found" {
			...
			utils.ErrorHandler(w, err, "Error deleting exec", http.StatusInternalServerError)
		}
		return
	}

	if err := utils.SendResponse[any](w, r, "exec deleted successfully", http.StatusOK, nil); err != nil {
