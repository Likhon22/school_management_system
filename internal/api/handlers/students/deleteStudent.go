...
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if err.Error() == "student not found" {
			...
			utils.ErrorHandler(w, err, "Error deleting student", http.StatusInternalServerError)
		}
		return
	}

	if err := utils.SendResponse[any](w, r, "student deleted successfully", http.StatusOK, nil); err != nil {
